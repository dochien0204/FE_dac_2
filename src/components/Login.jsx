...
export default function Login() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      const userId = resp.data.results.userId;
      const respUser = await axiosInstance.get("/api/user/profile", {
        params: {
          userId: resp.data.results.userId,
        },
      });
      window.localStorage.setItem("avatar", respUser.data.result.avatar);
